...
// A Vercel roda esse arquivo como função serverless: ela mesma importa o
// "app" exportado lá embaixo e chama cada requisição, sem nunca dar
// app.listen(). Se a gente chamasse app.listen() lá em cima incondicionalmente,
// o build/execução na Vercel quebraria tentando abrir uma porta que não faz
// sentido nesse ambiente. Por isso todo o bloco abaixo (listen + shutdown)
// só roda quando NÃO estamos na Vercel (ou seja, continua funcionando 100%
// igual antes no seu computador com "npm run dev").
...
// Exporta o app do Express para a Vercel usar como handler serverless.
// Isso não muda nada de como o servidor roda localmente (npm run dev
// continua chamando app.listen normalmente, no bloco acima).
export default app;